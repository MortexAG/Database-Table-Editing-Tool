...
try :
  ...
  def table_contents():
    ...
    uname_lb = Label(newWindow, text="Username")
    ...
    uid_lb = Label(newWindow, text="User ID")
    ...
    msg_lb = Label(newWindow, text="Message Content")
  ...
  def db_insert():
    ...
    lbl.config(text = "User Input Successful: "+inpuser)
    sql = """ INSERT INTO `{}` (id, {}, {}, {}) VALUES (0, '{}', '{}', '{}')""".format(db_table, db_column1, db_column2, db_column3, inpuser, inpuid, inpmsg)
    cursor.execute(sql)
    mydb.commit()

  # TextBox Creation
  username = tk.Label(top, text = "Add Username Here")
  username.pack()

  inputuser = Entry(top, width = 15)
  inputuser.pack()

  username = tk.Label(top, text = "Add User ID Here")
  username.pack()

  inputuserid = Entry(top, width = 15)
  inputuserid.pack()

  usermsg = tk.Label(top, text = "Add Message Content Here")
  usermsg.pack()
  ...
  def signin():
    ...
    def submit_signin():
      ...
      try:
        ...
        acstate_color = "Green"
        file = open("./.env", 'w')
        signin = "db_password = {} \ndb_username = {} \ndb_hostname = {} \ndb_table = {} \ndb_column1 = {} \ndb_column2 = {} \ndb_column3 = {}".format(db_inputpasssign, db_inputnamesign, db_inputhostsign, db_input_table_sign, db_input_column1_sign, db_input_column2_sign, db_input_column3_sign)
        file.write(signin)
        file.close()
